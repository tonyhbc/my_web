...
I am a biomedical data scientist trained in `Statistical Theory`, `Epidemiology`, and `Bioinformatics`. My research interests broadly lay on biostatistical methods for analysis of observational studies (_causal inference, missingness, measurement error_) and dealing with high-dimensional biomedical data (_regularization, random forest_).
